...
<html lang="en">
    ...
    <title>Zeynel Akçay Blog Yönetim</title>
    ...
    <!-- DataTables CSS -->
    <link href="/application/views/admin/theme/vendor/datatables-plugins/dataTables.bootstrap.css" rel="stylesheet"/>

    <!-- DataTables Responsive CSS -->
    <link href="/application/views/admin/theme/vendor/datatables-responsive/dataTables.responsive.css" rel="stylesheet"/>

    <!-- Custom CSS -->
    <link href="/application/views/admin/theme/dist/css/sb-admin-2.css" rel="stylesheet"/>

    <!-- Morris Charts CSS -->
    <link href="/application/views/admin/theme/vendor/morrisjs/morris.css" rel="stylesheet"/>
...
<div id="wrapper">
	...
	<div class="navbar-header">
	    ...
	    <a class="navbar-brand" href="/Admin/Dashboard">Zeynel Akçay Blog Yönetim</a>
	</div>
	<!-- /.navbar-header -->
