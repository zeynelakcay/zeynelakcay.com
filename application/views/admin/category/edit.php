<div id="page-wrapper">
	...
	<div class="col-lg-12">
		...
		<div class="panel-body">
		    ...
		    <div class="row">
			<form role="form" method="post" action="/Admin/Category/edit/<?php echo $category['category_id']; ?>">
				...
				<div class="col-lg-6">
				    <label>Seo Url</label>
				    <input type="text" name="seo_title"  value="<?php echo $category['seo_title']; ?>" class="form-control">
				</div>
			    </div>
			    <div class="form-group">
				<div class="col-lg-2">
				    <label>Sıralama</label>
				    <input type="number" name="order" value="<?php echo $category['order']; ?>" class="form-control">
				</div>
				<div class="col-lg-2">
				    <label>Durumu</label>
					...
					if ($category['status'])
					{
					    ?>selected<?php } ?>value="1"><span class="danger">Aktif</span></option>
					<option <?php
					if (!$category['status'])
					{
